 ...
 * File Name:RoutingDataSource.java
 * Package Name:com.chenxun.springboot.mybatis
 * Date:2016年8月19日上午10:41:57
...
/**
 * ClassName:RoutingDataSource <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason:	 TODO ADD REASON. <br/>
 * Date:     2016年8月19日 上午10:41:57 <br/>
 * @author 陈勋
 * @version
 * @since JDK 1.7
 * @see
...
public class RoutingDataSource extends AbstractDataSource implements InitializingBean {
  ...
  public void init() throws SQLException {
    if (this.defaultTargetDataSource != null) {
      if (this.defaultTargetDataSource instanceof DruidDataSource) {
        DruidDataSource druidDataSource = (DruidDataSource) this.defaultTargetDataSource;
        druidDataSource.init();
      }
    }
    if (this.targetDataSources != null && this.targetDataSources.size() > 0) {
